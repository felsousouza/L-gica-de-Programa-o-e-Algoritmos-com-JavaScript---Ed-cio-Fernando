...
function apostarNumero() {
    ...
    if (numero == sorteado) {
        ...
        //exibi o btJogar. La no html, ele esta com class="oculto".
        btJogar.className = "exibe";
        outDica.textContent = "Parabéns!! Número sorteado: " + sorteado;
    } else {

        /* se número existe no vetor erros
        indexOf ele procura no vetor o numero, se o resultado for maior que 0
        significa que o numero digitado já foi digitado e ja esta armazenado em algum elemento do vetor
        lembrando que cada item do vetor ocupa um espaco e começa do 0, 1, 2 e assim por diante
        por isso que se o retultado for menor que 0, significa que não encontrou nenhum elemento do vetor com aquele valor */
